  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'tip', value: 'Часто на стендапе обсуждают проблемы с железом: "My laptop is slow" (Мой ноутбук медленный), "I need more RAM" (Мне нужно больше памяти), "The charger is broken" (Зарядное устройство сломано), "Can I get a second monitor?" (Могу я получить второй монитор?)' },
        { type: 'note', value: 'Полезное правило: "hardware" (аппаратное обеспечение) — это то, что можно потрогать. "Software" (программное обеспечение) — то, что нельзя потрогать. "The problem is in the hardware, not the software." (Проблема в железе, не в программе.)' }
      ]
    },
    {
      id: 2,
      ...
      content: [
        ...
        { type: 'tip', value: 'DevTools (инструменты разработчика) — откройте нажатием F12 или Ctrl+Shift+I. Вкладки: "Elements" (элементы), "Console" (консоль), "Network" (сеть), "Performance" (производительность), "Application" (приложение). Знание этих названий обязательно для веб-разработчика.' },
      ]
    },
    {
      id: 3,
      ...
      content: [
        ...
        { type: 'tip', value: 'В командной строке часто работают с файлами на английском: "list files" (ls), "change directory" (cd), "create directory" (mkdir), "remove file" (rm). Команды в терминале — это тоже английский язык!' },
      ]
    },
    {
      id: 4,
      ...
      content: [
        ...
        { type: 'code', language: 'text', value: 'Действия с приложениями:\ninstall     - установить\nuninstall   - удалить\nlaunch      - запустить\nquit / exit - выйти\nrestart     - перезапустить\nupdate      - обновить\nconfigure   - настроить\nenable      - включить\ndisable     - выключить' },
      ]
    },
    {
      id: 5,
      ...
      content: [
        ...
        { type: 'tip', value: 'Частые фразы о сети: "Is the WiFi stable?" "Can you check your connection?" "My internet is slow today." "Let me reconnect." "Can you see my screen?" — типичные фразы для zoom-созвонов.' },
      ]
    },
    {
      id: 6,
      ...
      content: [
        ...
        { type: 'note', value: 'Никогда не делитесь в открытых каналах: API key (API-ключ), password (пароль), access token (токен доступа), private key (приватный ключ). При запросе чувствительных данных: "Please share this securely." (Пожалуйста, передайте безопасно.)' },
      ]
    },
    {
      id: 7,
