  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'tip', value: 'В IT-текстах артикли встречаются повсюду. "A bug" — любой баг (один из многих). "The bug" — конкретный баг, который уже упоминался. "The server is down" — конкретный сервер (наш, общий для команды).' },
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'note', value: 'В названиях технологий и продуктов артикль не нужен: "I use React" (не "the React"), "She works on Python" (не "the Python"). Но: "The internet" — всегда с "the", так как интернет один. "I use the internet" — правильно.' },
      ]
    },
    {
      id: 5,
