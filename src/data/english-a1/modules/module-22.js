  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'tip', value: 'Стратегия чтения README: сначала прочитайте первый абзац (что это?), затем Features (что умеет?), затем Installation (как установить?). Changelog читайте снизу вверх — последние изменения сверху. Это сэкономит время при знакомстве с проектом.' }
      ]
    },
    {
      id: 2,
      ...
      content: [
        ...
        { type: 'tip', value: 'При проблемах с установкой ищите: "Troubleshooting" (устранение неполадок), "Known issues" (известные проблемы), "FAQ" (часто задаваемые вопросы). Если не помогло: "Open an issue" в GitHub с текстом ошибки.' },
      ]
    },
    {
      id: 3,
      ...
      content: [
        ...
        { type: 'note', value: 'Как читать примеры кода: замените "your-api-key" на реальный ключ. "example.com" — пример домена, замените на ваш. "TODO" в коде — надо реализовать самостоятельно. "// ..." — пропущенный код для краткости.' },
      ]
    },
    {
      id: 4,
      ...
      content: [
        ...
        { type: 'tip', value: 'Changelog читайте по разделам: "Breaking changes" — обязательно перед обновлением. "New features" — что добавили. "Bug fixes" — что починили. "Deprecated" — что скоро удалят. "Removed" — что уже убрали.' },
      ]
    },
    {
      id: 5,
      ...
      content: [
        ...
        { type: 'note', value: 'В API документации: "Required parameters" — без них запрос упадёт. "Optional parameters" — для расширенного поведения. "Default values" — если не передавать параметр. "Rate limits" — чтобы не получить 429 Too Many Requests.' },
      ]
    },
    {
      id: 6,
