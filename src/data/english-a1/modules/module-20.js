  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'note', value: 'Структура вопроса с What: What + вспомогательный глагол (is/do/does/did) + подлежащее + основной глагол? Пример: "What does this API return?" (What + does + this API + return?) — вспомогательный does выражает настоящее время.' }
      ]
    },
    {
      id: 2,
      ...
      content: [
        ...
        { type: 'code', language: 'text', value: 'IT-вопросы с Where/When/Who:\nWhere is the bug?              - Где баг?\nWhere do you store the logs?   - Где хранишь логи?\nWhen did it start failing?     - Когда начало падать?\nWhen is the next release?      - Когда следующий релиз?\nWho reviewed this PR?          - Кто проверил PR?' },
      ]
    },
    {
      id: 3,
      ...
      content: [
        ...
        { type: 'tip', value: 'На оценке задач: "How long will this take?" "How many story points?" "How complex is it?" "How many developers do we need?" "How soon can we deploy?" — все эти вопросы звучат на planning meetings.' },
      ]
    },
    {
      id: 4,
      ...
      content: [
        ...
        { type: 'note', value: 'На architectural decision review: "Why did you choose this technology?" "Which database is better for our use case?" "Why is this approach better?" — ведут к богатым техническим обсуждениям.' },
      ]
    },
    {
      id: 5,
      ...
      content: [
        ...
        { type: 'tip', value: 'В IT-команде tag questions для подтверждения: "The server is running, isn\'t it?" "You reviewed the PR, didn\'t you?" "We cannot deploy on Fridays, can we?" Они звучат вежливо и профессионально.' },
      ]
    },
    {
      id: 6,
      ...
      content: [
        ...
        { type: 'note', value: 'Эффективные вопросы на технических встречах: Начинайте с "Could you explain...?" вместо "Explain this." Используйте "What do you think about...?" для получения мнения. "Have you considered...?" для предложений.' },
      ]
    },
    {
      id: 7,
