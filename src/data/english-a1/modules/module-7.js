  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'note', value: 'Согласование: there IS + единственное число (a bug, an error, one file). There ARE + множественное число (two bugs, some errors, many files). Всегда проверяйте, одно или несколько!' }
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'note', value: 'В FAQ документации вы увидите: "Are there any limitations?" (Есть ли ограничения?) "There are some known issues with..." (Есть некоторые известные проблемы с...) "Is there any documentation?" (Есть ли документация?) Теперь вы можете читать эти секции!' },
      ]
    },
    {
      id: 4,
      ...
      content: [
        ...
        { type: 'tip', value: 'На ретроспективах используется прошедшее время: "There was a deployment issue." (Был проблем с деплоем.) "There were merge conflicts." (Были конфликты слияния.) "Was there a postmortem?" (Был ли постмортем?) — анализ инцидента.' },
      ]
    },
    {
      id: 5,
      ...
      content: [
        ...
        { type: 'tip', value: 'На стендапе очень удобно использовать эти конструкции: "There are no blockers." (Нет блокеров.) — самая частая фраза. "There is one blocker." (Есть один блокер.) — когда проблема есть. "There was an incident last night." (Прошлой ночью был инцидент.)' }
      ]
    },
    {
      id: 6,
