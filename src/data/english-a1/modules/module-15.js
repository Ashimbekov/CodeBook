export default {
  ...
  description: 'Профессии, рабочие процессы, должности в IT',
  lessons: [
    {
      id: 1,
    ...
    {
      id: 3,
      title: 'Место работы и рабочие условия',
      type: 'theory',
      content: [
    ...
    {
      id: 4,
      title: 'Рабочие процессы и инструменты',
      type: 'theory',
      content: [
    ...
    {
      id: 7,
      title: 'Практика: Работа и профессии',
      type: 'practice',
      content: [
        {
          type: 'task',
          taskType: 'translate',
          question: 'Как вы ответите на вопрос "What do you do?"',
          solution: 'I\'m a [your role] developer. / I work as a [your role].',
          explanation: 'Стандартный ответ: "I\'m a backend developer" или "I work as a software engineer." Используйте форму "I\'m a + профессия".'
        },
        {
          type: 'task',
          taskType: 'match',
          question: 'Соедините должности с описаниями:',
          pairs: [
            { left: 'junior developer', right: 'начинающий разработчик' },
            { left: 'team lead', right: 'руководитель команды' },
            { left: 'QA engineer', right: 'инженер по тестированию' },
            { left: 'product manager', right: 'продакт-менеджер' }
          ],
          explanation: 'Стандартные IT-должности и их переводы.'
        },
        {
          type: 'task',
          taskType: 'translate',
          question: 'Переведите: "Я ищу удалённую работу фулстек-разработчиком."',
          solution: 'I\'m looking for a remote job as a full-stack developer.',
          explanation: 'looking for = искать. remote job = удалённая работа. as a = в качестве.'
        }
      ]
    }
  ]
