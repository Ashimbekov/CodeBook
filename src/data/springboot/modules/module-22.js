export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'При запуске приложения планировщик зарегистрирован. В логах:\nINFO  Scheduling: next trigger for sendDailyReport: 2026-03-23 09:00:00 Asia/Almaty\nINFO  Scheduling: next trigger for sendWeeklyDigest: 2026-03-23 10:00:00 Asia/Almaty\nINFO  Scheduling: next trigger for cleanupTokens: 2026-03-21 11:00:00\nINFO  Scheduling: next trigger for updateActiveUsers: 2026-03-21 10:00:30\n\nЧерез 30 секунд в логах:\nINFO  Запуск задачи обновления активных пользователей\n\nКаждый час:\nINFO  Очистка токенов: 2026-03-21T11:00:00\nINFO  Удалено просроченных токенов: 3\n\nВ 9:00 по рабочим дням:\nINFO  Запуск ежедневного отчёта\n\nЕсли reportService выбросит исключение:\nERROR Ошибка отчёта: Connection refused — планировщик продолжает работу.',
