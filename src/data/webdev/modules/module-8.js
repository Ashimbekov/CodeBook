  ...
  lessons: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'heading', value: 'Практические паттерны flex' },
        { type: 'code', language: 'css', value: '/* Три колонки равной ширины */\n.col { flex: 1; }\n\n/* Боковая панель фиксированная, контент растягивается */\n.sidebar { flex: 0 0 280px; }\n.content { flex: 1; }\n\n/* Карточки с минимальной шириной */\n.card { flex: 1 1 250px; max-width: 400px; }' },
        { type: 'tip', value: 'flex: 1 — сокращение для flex: 1 1 0. Это значит: расти (1), сжиматься (1), базовый размер 0. Все элементы с flex: 1 получат одинаковое пространство независимо от содержимого.' }
      ]
    },
    {
      id: 6,
