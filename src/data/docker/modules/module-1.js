export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Hello from Docker!\nThis message shows that your installation appears to be working correctly.\n\nКонтейнер Ubuntu создан, файл /tmp/hello.txt сохранён внутри первого контейнера.\nВ новом контейнере Ubuntu файл /tmp/hello.txt отсутствует — данные эфемерны.\n\nNginx запущен: docker ps показывает контейнер my-nginx со статусом Up.\nhttp://localhost:8080 возвращает страницу приветствия nginx.\n\nLogs nginx:\n172.17.0.1 - - [21/Mar/2026:10:00:00 +0000] "GET / HTTP/1.1" 200 615 "-" "curl/7.88.1"\n\nКонтейнеры остановлены и удалены: docker ps возвращает пустой список.',
