export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'docker compose ps:\nNAME              SERVICE       STATUS          PORTS\nmyapp-postgres-1  postgres      Up (healthy)    5432/tcp\nmyapp-redis-1     redis         Up (healthy)    6379/tcp\nmyapp-app-1       app           Up              80/tcp\nmyapp-nginx-1     nginx-proxy   Up              0.0.0.0:80->80/tcp\n\ndocker compose exec postgres psql -U postgres -c "\\l":\n   Name    | Owner\n-----------+----------\n myapp     | postgres\n\ndocker compose config — выводит итоговую merged конфигурацию без ошибок.',
