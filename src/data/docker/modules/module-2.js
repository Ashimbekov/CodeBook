export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Docker version 25.0.3, build 4debf41\n\ndocker ps без sudo выполняется успешно — пустой список контейнеров.\n\nLogging Driver: json-file\n\ndocker info показывает:\n  Storage Driver: overlay2\n  Cgroup Driver: systemd\n  Runtimes: runc io.containerd.runc.v2\n\ndocker system df:\nTYPE            TOTAL     ACTIVE    SIZE      RECLAIMABLE\nImages          0         0         0B        0B\nContainers      0         0         0B        0B\nLocal Volumes   0         0         0B        0B\n\nenabled — Docker автоматически запускается при старте системы.',
