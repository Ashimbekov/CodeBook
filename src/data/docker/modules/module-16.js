export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: './audit.sh:\n=== DOCKER AUDIT REPORT ===\n\n--- Running containers ---\nNAMES       IMAGE   STATUS\nbad-app1    nginx   Up 2 minutes\nbad-app2    nginx   Up 2 minutes\nbad-app3    nginx   Up 2 minutes\n\n--- Resource usage ---\nNAME       CPU %   MEM USAGE / LIMIT\nbad-app3   0.00%   5MiB / 32MiB  <- мало памяти!\n\n--- User check ---\n/bad-app2: root\n\n--- ENV secrets check ---\nWARNING: /bad-app1 has potential secrets in ENV!\n\n--- Disk usage ---\nImages: 200MB reclaimable.',
