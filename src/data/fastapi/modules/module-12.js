export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'GET /posts?page=2&size=5 → 200 OK, body: [{...5 постов...}] (offset=5, limit=5 вычисляется автоматически)\nGET /posts?q=fa&sort_by=title&sort_order=asc → 200 OK, отсортированный список\nGET /posts?sort_by=invalid → 422 Unprocessable Entity (pattern validation)\nDELETE /posts/1 (автор поста) → 200 OK, body: {"deleted": true}\nDELETE /posts/1 (не автор, не ADMIN) → 403 Forbidden, body: {"detail": "Нет прав"}\nDELETE /posts/99 → 404 Not Found, body: {"detail": "Не найдено"}',
