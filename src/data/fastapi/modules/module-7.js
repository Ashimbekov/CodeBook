export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'POST /tasks с body {"title": "Написать тесты", "priority": "HIGH"} → 201 Created, body: {"id": 1, "title": "Написать тесты", "status": "TODO", "priority": "HIGH", "assignee_id": null, "created_at": "...", "updated_at": "..."}\nGET /tasks → 200 OK, body: [{"id": 1, "title": "Написать тесты", "status": "TODO", ...}]\nPATCH /tasks/1 с body {"status": "IN_PROGRESS"} → 200 OK, body: {"id": 1, "status": "IN_PROGRESS", "updated_at": "..."}\nPATCH /tasks/1/complete → 200 OK, body: {"id": 1, "status": "DONE", ...}\nDELETE /tasks/1 → 200 OK (soft delete: deleted_at устанавливается)',
