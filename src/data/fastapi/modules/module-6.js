export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'POST /register с корректными данными → 200 OK, body: {"success": true, "message": "Регистрация успешна"}\nPOST /register с паролем "weak" → 422 Unprocessable Entity, body: {"success": false, "errors": [{"field": "password", "message": "Пароль должен содержать: минимум 8 символов, хотя бы одна заглавная буква, хотя бы одна цифра, хотя бы один спецсимвол"}]}\nPOST /register с birth_date: "2015-01-01" → 422, body: {"success": false, "errors": [{"field": "birth_date", "message": "Регистрация только для 18+."}]}\nPOST /register с username "Bad User!" → 422, body: {"success": false, "errors": [{"field": "username", "message": "Логин: только буквы a-z, цифры, _"}]}',
