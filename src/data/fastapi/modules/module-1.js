export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'GET /todos → 200 OK, body: []\nPOST /todos?title=Купить+молоко → 201 Created, body: {"id": 1, "title": "Купить молоко", "completed": false}\nGET /todos/1 → 200 OK, body: {"id": 1, "title": "Купить молоко", "completed": false}\nGET /todos/99 → 404 Not Found, body: {"detail": "Задача не найдена"}\nDELETE /todos/1 → 204 No Content',
