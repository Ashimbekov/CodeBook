export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'GET /products?page=1&size=10 → 200 OK, body: {"items": [...], "total": 2}\nGET /products?tags=sale → 200 OK, body: {"items": [{"id": 2, "name": "Телефон", ...}], "total": 2}\nGET /products/search?q=ноут&min_price=100000&sort=price → 200 OK, body: [{"id": 1, "name": "Ноутбук", "price": 150000}]\nGET /products/search?sort=invalid → 422 Unprocessable Entity (pattern validation)\nGET /products/0 → 422 Unprocessable Entity (Path(gt=0) не прошёл)',
