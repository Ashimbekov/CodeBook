export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'GET /products?page=1&size=10 → 200 OK, body: {"items": [], "total": 0, "page": 1, "size": 10, "pages": 0}\nPOST /products?name=Ноутбук&price=150000 → 201 Created, headers: Location: /products/1, body: {"success": true, "data": {"id": 1, "name": "Ноутбук", "price": 150000}}\nGET /products/1 → 200 OK, body: {"success": true, "data": {"id": 1, "name": "Ноутбук", "price": 150000}, "message": "OK"}\nGET /products/99 → 404 Not Found, body: {"success": false, "data": null, "message": "Продукт не найден"}\nDELETE /products/1 → 204 No Content',
