export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'POST /users с body {"name": "иван петров", "email": "ivan@example.com", "password": "Secret123", "password_confirm": "Secret123", "age": 25} → 201 Created, body: {"id": 1, "name": "Иван Петров", "email": "ivan@example.com", "created_at": "2024-01-01T12:00:00"}\nПароль в ответе ОТСУТСТВУЕТ (response_model фильтрует)\nPOST /users с несовпадающими паролями → 422 Unprocessable Entity\nGET /users/1 → 200 OK, body: {"id": 1, "name": "Иван Петров", "email": "ivan@example.com", "created_at": "..."}',
