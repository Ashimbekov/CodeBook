  ...
  lessons: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'heading', value: 'Скрытие и устаревание эндпоинтов' },
        { type: 'code', language: 'python', value: '# include_in_schema=False — скрывает эндпоинт из документации (но он работает)\n@app.get("/internal/health", include_in_schema=False)\ndef internal_health():\n    return {"status": "ok"}\n\n# deprecated=True — помечает эндпоинт как устаревший в Swagger UI\n@app.get("/v1/items", deprecated=True, tags=["items"])\ndef list_items_v1():\n    """Используйте /v2/items вместо этого эндпоинта"""\n    return []\n\n@app.get("/v2/items", tags=["items"])\ndef list_items_v2():\n    """Актуальный эндпоинт с улучшенным форматом"""\n    return {"items": [], "total": 0}' },
        { type: 'heading', value: 'Версионирование API через prefix' },
        ...
        { type: 'tip', value: 'Упорядочивай теги в openapi_tags в том порядке, в котором они должны отображаться в Swagger UI. Тег без описания в openapi_tags тоже работает, но отображается без описания.' }
      ]
    },
    {
      id: 5,
