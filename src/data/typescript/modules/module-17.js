export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Компонент TodoList рендерится в браузере.\nДобавление задачи "Купить продукты":\n  Задач: 1, выполнено: 0\n  [ ] Купить продукты [Удалить]\n\nДобавление задачи "Позвонить врачу":\n  Задач: 2, выполнено: 0\n\nОтметить "Купить продукты" выполненной:\n  Задач: 2, выполнено: 1\n  [x] ~~Купить продукты~~ [Удалить]\n  [ ] Позвонить врачу [Удалить]\n\nУдалить "Купить продукты":\n  Задач: 1, выполнено: 0\n\nTypeScript компилируется без ошибок: tsc --noEmit выдаёт 0 предупреждений.',
