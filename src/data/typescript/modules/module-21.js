export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: '{ name: [ \'Минимум 3 символов\' ], email: [ \'Некорректный email\' ], password: [ \'Минимум 8 символов\' ] }',
    ...
    },
    {
      ...
      expectedOutput: '[Лог] Температура: 22°C\n[Лог] Температура: 25°C\n23.5',
    ...
    },
    {
      ...
      expectedOutput: 'User(1710000000000: Алиса, user)\nUser(1710000000000: Алиса, admin)\nuser',
    ...
    },
    {
      ...
      expectedOutput: '{ age: 30, name: \'Боб\' }\nНевалидное значение "-5" для поля "age"',
    ...
    },
    {
      ...
      expectedOutput: 'Статус изменён: pending -> confirmed\nСтатус изменён: pending -> confirmed -> shipped\nСтатус изменён: pending -> confirmed -> shipped -> delivered\nНельзя перейти из "delivered" в "cancelled". Допустимо: []',
