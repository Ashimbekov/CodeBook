export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'API запущено на :3000\n\nGET /api/tasks\n→ HTTP 200: []\n\nPOST /api/tasks  {title: "Написать тесты"}\n→ HTTP 201: {id: 1710000000000, title: "Написать тесты", completed: false, createdAt: "2024-..."}\n\nGET /api/tasks\n→ HTTP 200: [{id: 1710000000000, title: "Написать тесты", completed: false}]\n\nPUT /api/tasks/1710000000000  {completed: true}\n→ HTTP 200: {id: 1710000000000, title: "Написать тесты", completed: true}\n\nDELETE /api/tasks/1710000000000\n→ HTTP 204 No Content\n\nGET /api/tasks/9999\n→ HTTP 404: {error: "Задача с id 9999 не найдена"}\n\nPOST /api/tasks  {}\n→ HTTP 400: {error: "title обязателен"}',
