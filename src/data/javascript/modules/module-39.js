export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      hint: 'Access token должен быть краткоживущим (15мин), refresh token — долгоживущим (7 дней). Храните refresh токены в Set для возможности отзыва. Защищённый маршрут проверяет Bearer токен в заголовке.',
      expectedOutput: 'POST /auth/register -> 201 { id: 1, email: "user@test.com" }\nPOST /auth/login -> { accessToken: "...", refreshToken: "..." }\nGET /profile с токеном -> 200 { id: 1, email: "..." }\nGET /profile без токена -> 401\nPOST /auth/refresh -> { accessToken: "новый токен" }',
