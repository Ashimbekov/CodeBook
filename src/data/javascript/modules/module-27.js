export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Порядок вывода: 1, 4, 3, 2 (синхронный код, macrotask, microtask)\nconsole.log("start") -> немедленно\nsetTimeout(fn, 0) -> после Promise.then\nPromise.resolve().then -> перед setTimeout',
