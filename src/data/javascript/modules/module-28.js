export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'reactive({ count: 0 }) -> при изменении count вызывается эффект\nwatch(() => state.count) -> выводит новое значение при каждом изменении\ncomputed(() => state.a + state.b) -> автоматически пересчитывается',
