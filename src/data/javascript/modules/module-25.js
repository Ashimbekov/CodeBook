export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'allSettledCustom([p1, p2, p3]) -> [{status:"fulfilled",value:1},{status:"rejected",reason:err},...]\nretry(flaky, 3, 100) -> успешно после 2-3 попыток\nwithTimeout(slowPromise, 100) -> отклоняется с TimeoutError',
