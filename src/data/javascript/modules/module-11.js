export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'formatName("иванов иван иванович") -> "Иванов И.И."\nparseCSV("Алма,25,Алматы") -> { name: "Алма", age: 25, city: "Алматы" }\nmaskCard("4111111111111111") -> "**** **** **** 1111"\ntruncate("Длинный текст для обрезки", 15) -> "Длинный текст ..."',
