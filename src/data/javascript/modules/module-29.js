export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'cache.set("key", largeObject) -> объект кэширован\ncache.get("key") -> возвращает объект пока GC не собрал\nfinalizationRegistry -> callback вызван после сборки мусора',
