export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      hint: 'Ищите дублирование кода — выносите в отдельные функции. Магические числа и строки заменяйте именованными константами. Длинные функции разбивайте на маленькие с понятными именами. Применяйте принцип единственной ответственности.',
      expectedOutput: 'Исходный код: 5 функций с дублированием, магические числа, непонятные имена\nПосле рефакторинга: DRY код, именованные константы, читаемые функции\nВсе тесты проходят (поведение не изменилось)\nКоличество строк сократилось на 30%',
