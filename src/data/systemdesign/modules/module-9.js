  ...
  lessons: [
    ...
    },
    {
      ...
      requirements: [
        ...
        'Сравнить Pull CDN и Push CDN применительно к сценарию',
        'Описать стратегию для динамического контента',
        'Оценить ожидаемый cache hit rate и снижение нагрузки на origin'
      ],
      hint: 'Раздели контент на категории: неизменяемые файлы (JS/CSS с хешем), редко меняющийся HTML, часто меняющееся API. Для каждой категории TTL и стратегия инвалидации будут разными. Файлы с хешем в имени можно кешировать на год.',
      expectedOutput: 'Для каждого типа контента (JS/CSS бандлы, HTML, изображения, видео, API) описана стратегия CDN с TTL и инвалидацией. Обоснован выбор Pull CDN. Ожидаемый cache hit rate рассчитан. Нагрузка на origin снижена в 10+ раз.',
