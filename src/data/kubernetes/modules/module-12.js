export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl label node minikube type=worker:\nnode/minikube labeled\n\nkubectl get daemonset node-monitor:\nNAME           DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE\nnode-monitor   1         1         1       1            1\n\nkubectl logs -l app=node-monitor:\nNode: minikube, Time: Thu Mar 21 10:00:00 UTC 2026\nLoad: 0.12 0.08 0.05 1/123 456\n\nПосле kubectl label node minikube type-:\nkubectl get pods -l app=node-monitor — пустой список.',
    ...
    },
    {
      ...
      expectedOutput: 'kubectl rollout status daemonset/node-monitor:\ndaemonset "node-monitor" successfully rolled out\n\nkubectl rollout history daemonset/node-monitor:\nREVISION  CHANGE-CAUSE\n1         <none>\n2         <none>\n\nПосле изменения стратегии на OnDelete и обновления образа:\nkubectl get pods — старые Pod остаются с прежним образом.\nПосле ручного kubectl delete pod <pod-name> новый Pod создаётся с новым образом.',
