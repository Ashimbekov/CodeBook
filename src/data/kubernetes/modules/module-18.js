export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get deployment production-app:\nNAME             READY   UP-TO-DATE   AVAILABLE\nproduction-app   3/3     3            3\n\nkubectl get pdb:\nNAME                  MIN AVAILABLE   MAX UNAVAILABLE   ALLOWED DISRUPTIONS\nproduction-app-pdb    2               N/A               1\n\nkubectl describe deployment production-app показывает:\n  startupProbe, livenessProbe, readinessProbe настроены.\n  Anti-affinity: preferredDuringScheduling по hostname.\n  Security context: runAsNonRoot=true.',
    ...
    },
    {
      ...
      expectedOutput: 'После удаления index.html Pod получает readiness failure:\nkubectl get endpoints production-service — Pod исключён из endpoints.\n\nRolling update с broken образом останавливается — 2 Pod остаются Running:\nkubectl rollout status deploy/production-app:\nWaiting for deployment rollout to finish: 1 out of 3 new replicas...\n\nPDB при drain:\nkubectl drain minikube --dry-run=client:\nWARNING: evicting pod production-app-xxx-1\nCannot evict pod as it would violate the pod disruption budget.\n\nPod в Terminating: остаётся ~10 секунд (preStop hook sleep 10).',
