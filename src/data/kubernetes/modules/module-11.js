export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl exec redis-0 -- redis-cli get mykey:\n"Hello Kubernetes"\n\nПосле kubectl delete pod redis-0 и ожидания нового Pod:\nkubectl exec redis-0 -- redis-cli get mykey:\n"Hello Kubernetes"\n\nkubectl exec redis-0 -- redis-cli get counter:\n"42"\n\nДанные сохранились — StatefulSet использует тот же PVC redis-data-redis-0.',
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get pods -w при масштабировании до 3:\nNAME      READY   STATUS    AGE\nredis-0   1/1     Running   5m\nredis-1   0/1     Pending   0s\nredis-1   1/1     Running   10s\nredis-2   0/1     Pending   10s\nredis-2   1/1     Running   20s\n\nkubectl get pvc:\nNAME                 STATUS   CAPACITY\nredis-data-redis-0   Bound    1Gi\nredis-data-redis-1   Bound    1Gi\nredis-data-redis-2   Bound    1Gi\n\nПосле масштабирования вниз до 1: PVC сохранились, Pod удалены в порядке 2, 1.',
