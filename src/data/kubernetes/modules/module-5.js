export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get services:\nNAME             TYPE        CLUSTER-IP      PORT(S)\nweb-clusterip    ClusterIP   10.96.10.5      80/TCP\nweb-nodeport     NodePort    10.96.10.6      80:30080/TCP\n\nkubectl run test-pod ... -- wget -qO- http://web-clusterip:\n<!DOCTYPE html>\n<html><head><title>Welcome to nginx!</title>...</html>\n\nnslookup web-clusterip:\nServer: 10.96.0.10\nName: web-clusterip.default.svc.cluster.local\nAddress: 10.96.10.5\n\nkubectl get endpoints web-clusterip:\nNAME           ENDPOINTS\nweb-clusterip  10.244.0.3:80,10.244.0.4:80,10.244.0.5:80',
    ...
    },
    {
      ...
      expectedOutput: '10 curl запросов к backend-service возвращают:\nbackend-response\nbackend-response\n...\n\nkubectl logs -l app=backend --prefix=true показывает:\n[pod/backend-xxx-1] 2026/03/21 10:00:01 Received request\n[pod/backend-xxx-2] 2026/03/21 10:00:02 Received request\n[pod/backend-xxx-1] 2026/03/21 10:00:03 Received request\n\nЗапросы равномерно распределены между двумя Pod благодаря Service балансировке.',
