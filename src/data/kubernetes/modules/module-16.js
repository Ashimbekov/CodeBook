export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'curl http://localhost:9200/_cluster/health:\n{"status":"green","number_of_nodes":1,"number_of_data_nodes":1}\n\ncurl http://localhost:9200/_cat/indices:\nyellow open logstash-2026.03.21 1 1 1523 0 1.2mb\n\nkubectl get pods -n logging:\nNAME                  READY   STATUS\nelasticsearch-0       1/1     Running\nkibana-xxx            1/1     Running\nfluentd-xxx           1/1     Running\n\nKibana http://localhost:5601 — Discover показывает логи test-app с полем message: "test log".',
