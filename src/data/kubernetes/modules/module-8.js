export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get pod nginx-default -n dev -o yaml | grep -A 10 resources:\nresources:\n  limits:\n    cpu: 200m\n    memory: 128Mi\n  requests:\n    cpu: 100m\n    memory: 64Mi\n\nkubectl describe resourcequota dev-quota -n dev:\nName: dev-quota\nNamespace: dev\nResource  Used  Hard\npods      1     10\n\nПри превышении квоты (pod-11):\nError from server (Forbidden): exceeded quota: dev-quota, requested: pods=1, used: pods=10, limited: pods=10',
