export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get pod nginx-full:\nNAME         READY   STATUS    RESTARTS   AGE\nnginx-full   1/1     Running   0          30s\n\nkubectl describe pod nginx-full показывает:\n  Liveness: http-get http://:80/ delay=10s period=5s\n  Limits: cpu=200m, memory=128Mi\n  Requests: cpu=100m, memory=64Mi\n\nkubectl exec nginx-full -- env | grep APP:\nAPP_ENV=production\nAPP_PORT=80',
    ...
    },
    {
      ...
      expectedOutput: 'kubectl get pod sidecar-demo:\nNAME           READY   STATUS    RESTARTS   AGE\nsidecar-demo   2/2     Running   0          15s\n\nkubectl logs sidecar-demo -c log-reader:\nThu Mar 21 10:00:05 UTC 2026 - app log\nThu Mar 21 10:00:10 UTC 2026 - app log\nThu Mar 21 10:00:15 UTC 2026 - app log\n\nОба контейнера используют общий emptyDir volume /var/log/app.',
