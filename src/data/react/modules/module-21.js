export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Button variant="primary" -> синяя кнопка с hover/active состояниями\nButton variant="danger" -> красная кнопка\nButton size="sm" -> маленькая кнопка\nButton disabled -> неактивная с курсором not-allowed\nКлассы через CSS Modules изолированы от глобальных стилей',
