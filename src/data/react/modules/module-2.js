export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Проект создан командой npm create vite@latest\nСтруктура: src/components/, src/pages/, src/hooks/, src/utils/\nАлиас "@" резолвится в src/\nnpm run dev запускает dev-сервер\nnpm run build создаёт оптимизированный бандл',
