export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Список товаров отображается с кнопкой "В корзину"\nКорзина показывает добавленные товары и количество\nИзменение количества обновляет итоговую сумму\nУдаление товара убирает его из корзины\nИтого: сумма цен × количеств всех товаров',
