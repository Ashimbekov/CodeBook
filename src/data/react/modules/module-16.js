export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Роут / -> список постов\nРоут /post/:id -> страница поста\nРоут /about -> о проекте\nРоут /user/:id -> профиль пользователя\nNavLink с activeStyle для активного пункта меню\n404 роут для неизвестных путей',
