export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'Главная страница: hero секция с заголовком и CTA\nСтраница /courses: список курсов с карточками\nСтраница /about: информация о школе\nLayout с навигацией на всех страницах\nMeta теги: title и description для каждой страницы',
