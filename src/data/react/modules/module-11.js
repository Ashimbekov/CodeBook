export default {
  ...
  lessons: [
    ...
    },
    {
      ...
      expectedOutput: 'При монтировании загружаются посты с jsonplaceholder.typicode.com\nСкелетон показывается во время загрузки\nСписок постов с пагинацией (10 на страницу)\nКлик по посту открывает детальный вид\nПри размонтировании fetch отменяется',
